function calcular(n1, n2) {
    ...
    switch (selector) {
        ...
        case '/':
            ...
            document.getElementById("resultado").innerHTML = `O resultado da divisao de ${n1} / ${n2} e = ${calculo}`
            break
            }
            case '*':
                calculo = Math.round((n1 * n2))
            ...
            document.getElementById("resultado").innerHTML = `O resultado da multiplicacao de ${n1} * ${n2} e = ${calculo}`
            break
            }
